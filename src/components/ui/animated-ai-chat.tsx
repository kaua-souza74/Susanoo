...
export function AnimatedAIChat() {
    ...
    const commandSuggestions: CommandSuggestion[] = [
        ...
        { 
            ...
            label: "Import Web", 
            description: "Import a design from a URL", 
            prefix: "/import" 
        },
        { 
    ...
    return (
        <div className="flex flex-col w-full items-center justify-center bg-transparent p-6 relative overflow-hidden">
            ...
            <div className="w-full max-w-2xl mx-auto relative">
                ...
                >
                    ...
                    <motion.div 
                        className="relative backdrop-blur-2xl bg-surface/50 rounded-2xl border border-surface-border shadow-2xl"
                        initial={{ scale: 0.98 }}
                        animate={{ scale: 1 }}
                        ...
                        <AnimatePresence>
                            {showCommandPalette && (
                                <motion.div 
                                    ...
                                    className="absolute left-4 right-4 bottom-full mb-2 backdrop-blur-xl bg-surface rounded-lg z-50 shadow-lg border border-surface-border overflow-hidden"
                            ...
                            {attachments.length > 0 && (
                                ...
                                >
                                    {attachments.map((file, index) => (
                                        <motion.div
                                            key={index}
                                            className="flex items-center gap-2 text-xs bg-foreground/5 py-1.5 px-3 rounded-lg text-foreground/70"
                        ...
                        <div className="p-4 border-t border-surface-border flex items-center justify-between gap-4">
                            <div className="flex items-center gap-3">
                                ...
                                >
                                    ...
                                    <motion.span
                                        className="absolute inset-0 bg-foreground/5 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity"
            ...
            <AnimatePresence>
                {isTyping && (
                    <motion.div 
                        className="fixed bottom-8 mx-auto transform -translate-x-1/2 backdrop-blur-2xl bg-surface/80 rounded-full px-4 py-2 shadow-lg border border-surface-border"
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
                        exit={{ opacity: 0, y: 20 }}
                    >
                        <div className="flex items-center gap-3">
                            <div className="w-8 h-7 rounded-full bg-accent flex items-center justify-center text-center">
                                <span className="text-[10px] font-bold text-white mb-0.5">IA</span>
                            </div>
